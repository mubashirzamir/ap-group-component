 ...
 */
const useEPCPResult = (ProviderChoice) => {
  // State for electrical provider consumption summary
  ...
  const fetchEPCPInformation = useCallback(async () => {
    ...
    try {
      const providerResponse = await DarlingtonService.getSummary();
